...
$competence = isset($_GET['competence']) ? $_GET['competence'] : 'developpement-application';

// Vérifier si la compétence existe
if (!isset($competences[$competence])) {
    $competence = 'developpement-application';
}

$competenceActuelle = $competences[$competence];
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title>Compétence - <?php echo $competenceActuelle['titre']; ?></title>
    ...
    <div class="container mt-5 pt-5">
        <div class="row mb-4">
            <div class="col-12 text-center">
                <i class="<?php echo $competenceActuelle['icon']; ?> fa-4x mb-3"></i>
                <h1 class="mb-3"><?php echo $competenceActuelle['titre']; ?></h1>
            </div>
        </div>
        
        <div class="row">
            <?php if (empty($competenceActuelle['projets'])): ?>
                <div class="col-12 text-center">
                    <p class="lead">Aucun projet n'a encore été ajouté pour cette compétence.</p>
                </div>
            <?php else: ?>
                <?php foreach ($competenceActuelle['projets'] as $projet): ?>
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <img src="<?php echo $projet['image']; ?>" alt="<?php echo $projet['titre']; ?>" class="img-fluid mb-3">
                                ...
                                <div class="d-flex flex-wrap">
                                    <?php foreach ($projet['technologies'] as $tech): ?>
                                        <span class="badge bg-primary m-1"><?php echo $tech; ?></span>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        </div>
